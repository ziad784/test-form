...
const causes_answers = [
    ...
    {"q14":`Because "probably" means something not certain, not sure. so, we put it with the words that has similar meanings. While the other groups don't suit the meaning of " probably"`},
    {"q15":`Because while reading the conversation you can recognize the character of Ibrahim from his words. Ibrahim encourages Faisal and said to him " still there are chances". So, you can understand that he has good attitude about life, which is something goodand positive .`},
